            ...
            <v-card-text class="pa-0">
              ...
              <v-row no-gutters>
                ...
                <v-col cols="9" class="pa-2">
                  <content-card
                    :content="`Red-green color blindness is caused by an X-linked recessive allele. A color-blind man marries a woman with normal vision whose father is color blind. Cross their genotypes using Punnett square, and answer the succeeding card.`"
                    :elevation="0"
